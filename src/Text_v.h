...
extern	char	*CSV2_PackValue(char *p, ValueStruct *value, size_t textsize);
extern	char	*CSV3_PackValue(char *p, ValueStruct *value, size_t textsize);
extern	char	*CSVE_PackValue(char *p, ValueStruct *value, size_t textsize);

extern	size_t	CSV1_SizeValue(ValueStruct *val, size_t arraysize, size_t textsize);
